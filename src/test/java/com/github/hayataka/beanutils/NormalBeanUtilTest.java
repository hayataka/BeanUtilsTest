...
public class NormalBeanUtilTest {
	...
	/**
	 * 標準的な説明用.
	 * @see http://www.ne.jp/asahi/hishidama/home/tech/apache/commons/beanutil.html
	 * @throws Exception
	 */
	@Test
	public void successPattern() throws Exception {
		...
		BeanUtilsBean bu = new BeanUtilsBean(new ConvertUtilsBean(), // 独自コンバーターを登録する為に新しいインスタンスを生成
		...
		bu.getConvertUtils().register(new DateToStringConverter(), // 独自コンバーターを
	 ...
	 * <p>SingleThreadでも、 （deRegisterを使用しなければ）問題となる</p>
	 */
	@Test
	public void ngPatternInSingleThread() {
		 ...
		 * 
		 *     it must be  Wed Mar 11 12:34:56 JST 2015
		 *     but ngUse method register another converter,
		 *     it is 2015/03/11 12:34:56
		 */
